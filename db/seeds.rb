...
@artist = Artist.create(name: "My Grtist", bio: "My artist bio")
@genre = Genre.create(name: "My Aenre")
@song = Song.create(name: "My Bong", artist_id: @artist.id, genre_id: @genre.id)
